...
void Runway::draw() {
    raylib::Rectangle rectangle( raylib::Vector2(this->runway_position.x, this->runway_position.y), raylib::Vector2(150, this->runway_length_px));
    DrawRectanglePro(rectangle, raylib::Vector2(0, 0), 0, BLUE);
}
